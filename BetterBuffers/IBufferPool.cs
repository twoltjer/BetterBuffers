...
public interface IBufferPool<T> where T : unmanaged
{
	...
	/// <param name="initializeWithDefaultValues">Initialize the array with default(<see cref="T"/>). True requires a little extra time. False can have past buffer values in the returned buffer.</param>
	...
	/// <exception cref="TypeLoadException">When <see cref="T"/> is a type that can't be loaded</exception>
	/// <exception cref="NotSupportedException">When <see cref="T"/> is a type that cannot be used for an array (e.g. pointers)</exception>
	/// <returns>A <see cref="T"/>[] with the given length</returns>
	...
	/// <param name="initializeWithDefaultValues">Initialize the buffer with default(<see cref="T"/>). True requires a little extra time. False can have past buffer values in the returned buffer.</param>
	/// <exception cref="OutOfMemoryException">Thrown when the request requires a heap allocation but the system cannot allocate the requested size</exception>
	...
	/// <exception cref="TypeLoadException">When <see cref="T"/> is a type that can't be loaded</exception>
	/// <exception cref="NotSupportedException">When <see cref="T"/> is a type that cannot be used for an array (e.g. pointers)</exception>
	/// <returns>A <see cref="T"/>[] with at least the given length</returns>
	...
	/// <returns>True if an buffer could rented, false otherwise.</returns>
